...
sudo scutil --set ComputerName "behaviors"
sudo scutil --set HostName "behaviors"
sudo scutil --set LocalHostName "behaviors"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "behaviors"
