...
set t_Co=16
hi StorageClass ctermbg=NONE ctermfg=6 cterm=NONE
...
hi Todo ctermbg=15 ctermfg=3 cterm=NONE
...
hi TabLineFill ctermbg=NONE ctermfg=15 cterm=NONE
...
hi CursorLine ctermbg=NONE ctermfg=15 cterm=NONE
...
hi Pmenu ctermbg=15 ctermfg=7 cterm=NONE
hi PmenuSbar ctermbg=6 ctermfg=7 cterm=NONE
hi PmenuSel ctermbg=4 ctermfg=0 cterm=NONE
hi PmenuThumb ctermbg=15 ctermfg=15 cterm=NONE
hi FoldColumn ctermbg=NONE ctermfg=7 cterm=NONE
hi Folded ctermbg=NONE ctermfg=15 cterm=NONE
hi WildMenu ctermbg=2 ctermfg=0 cterm=NONE
hi SpecialKey ctermbg=NONE ctermfg=15 cterm=NONE
hi DiffAdd ctermbg=NONE ctermfg=2 cterm=NONE
hi DiffChange ctermbg=NONE ctermfg=15 cterm=NONE
...
hi ErrorMsg ctermbg=NONE ctermfg=15 cterm=NONE
...
hi CursorColumn ctermbg=15 ctermfg=7 cterm=NONE
...
hi vimCommentString ctermbg=NONE ctermfg=15 cterm=NONE
...
hi cssNoise ctermbg=NONE ctermfg=15 cterm=NONE
...
hi rubyTodo ctermbg=NONE ctermfg=15 cterm=NONE
